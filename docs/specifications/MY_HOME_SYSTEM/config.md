...
* 根拠: [HEALTH_WATCH_DEADMAN_PING_*定義] (行番号: 661〜662 / 抜粋: "HEALTH_WATCH_DEADMAN_PING_URL: str = os.getenv(\"HEALTH_WATCH_DEADMAN_PING_URL\", \"\")\nHEALTH_WATCH_DEADMAN_PING_TIMEOUT_SEC: int = _get_int_env(\"HEALTH_WATCH_DEADMAN_PING_TIMEOUT_SEC\", 10)")
...
* 根拠: `def _resolve_assets_dir() -> str:` (行番号: 686)、`def __getattr__(name: str) -> str:` (行番号: 700)、`def prewarm_nas_paths() -> None:` (行番号: 727)
