...
* 根拠: `cleanup_handler` (行番号: 104〜120 / 抜粋: "def cleanup_handler(signum: int, frame: Any) -> None:")、[ロック保護下のスナップショット取得] (行番号: 99〜100 / 抜粋: "with _pullpoints_lock:\n        pullpoints_snapshot = list(active_pullpoints)")


* **引数/リクエスト**: `signum: int` (シグナル番号), `frame: Any` (実行フレーム)
* 根拠: `cleanup_handler` (行番号: 104 / 抜粋: "def cleanup_handler(signum: int, frame: Any) -> None:")
...
* 根拠: `is_host_reachable` (行番号: 125〜141 / 抜粋: "def is_host_reachable(ip:")


* **引数/リクエスト**: `ip: str` (対象のIPアドレス)
* 根拠: `is_host_reachable` (行番号: 125 / 抜粋: "def is_host_reachable(ip: str)")
...
* 根拠: `find_wsdl_path` (行番号: 143〜153 / 抜粋: "def find_wsdl_path() ->")


* **引数/リクエスト**: なし
* 根拠: `find_wsdl_path` (行番号: 143 / 抜粋: "def find_wsdl_path() ->")
...
* 根拠: `perform_emergency_diagnosis` (行番号: 157〜173 / 抜粋: "def perform_emergency_diagnosis")
...
* 根拠: `check_camera_time` (行番号: 175〜206 / 抜粋: "def check_camera_time(devicemgmt")
...
* 根拠: `capture_snapshot_from_nvr` (行番号: 222〜308 / 抜粋: "def capture_snapshot_from_nvr(")
...
* 根拠: `save_image_from_stream` (行番号: 311〜337 / 抜粋: "def save_image_from_stream(")
...
* 根拠: `force_close_session` (行番号: 339〜362 / 抜粋: "def force_close_session(")
...
* 根拠: `process_camera_event` (行番号: 364〜433 / 抜粋: "def process_camera_event(")
...
* 根拠: `monitor_single_camera` (行番号: 436〜690 / 抜粋: "def monitor_single_camera(")
...
* 根拠: `main` (行番号: 692〜702 / 抜粋: "async def main() -> None:")


* **引数/リクエスト**: なし
* 根拠: `main` (行番号: 692 / 抜粋: "async def main() -> None:")
