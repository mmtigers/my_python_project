...
* 根拠: [定義] (行番号: 156 / 抜粋: "def redact_secrets(text: str) -> tuple[str, int]:")
...
* 根拠: [定義] (行番号: 402 / 抜粋: "def prune(base: Path, retention_days: int | None = None,")
...
* **役割**: CLI / ログ向けの人が読む要約
* 根拠: [定義] (行番号: 442 / 抜粋: "def format_summary_lines(outcome: BackupOutcome) -> list[str]:")
