...
* 根拠: `@dataclass\nclass CheckResult:` (行番号: 55〜58 / 抜粋: "class CheckResult:\n    name: str\n    status: str\n    message: str")
...
* **副作用**: なし
* 根拠: (行番号: 55〜58 / 抜粋: "class CheckResult:")
...
* 根拠: `class PostBootHealthCheck:` (行番号: 60〜456 / 抜粋: "class PostBootHealthCheck:")


* **引数/リクエスト**: なし（コンストラクタは引数なし）
* 根拠: `def __init__(self):` (行番号: 61 / 抜粋: "def __init__(self):")


* **戻り値/レスポンス**: 該当なし（クラス定義）
* 根拠: (行番号: 60 / 抜粋: "class PostBootHealthCheck:")
...
* 根拠: `def __init__(self):` (行番号: 61〜67 / 抜粋: "def __init__(self):\n        self.max_retries = 12       \n        self.retry_interval = 10    \n        self.results: List[CheckResult] = []")


* **引数/リクエスト**: `self` のみ
* 根拠: (行番号: 61 / 抜粋: "def __init__(self):")
...
* 根拠: `def _check_port(self, host: str, port: int, timeout=3) -> bool:` (行番号: 70〜75 / 抜粋: "def _check_port(self, host: str, port: int, timeout=3) -> bool:")


* **引数/リクエスト**: `host: str`, `port: int`, `timeout=3`
* 根拠: (行番号: 70 / 抜粋: "def _check_port(self, host: str, port: int, timeout=3) -> bool:")
...
* 根拠: `def _check_http(self, url: str, timeout=5, headers=None) -> bool:` (行番号: 77〜82 / 抜粋: "def _check_http(self, url: str, timeout=5, headers=None) -> bool:")


* **引数/リクエスト**: `url: str`, `timeout=5`, `headers=None`
* 根拠: (行番号: 77 / 抜粋: "def _check_http(self, url: str, timeout=5, headers=None) -> bool:")
...
* 根拠: `def _get_uptime(self) -> str:` (行番号: 84〜95 / 抜粋: "def _get_uptime(self) -> str:")


* **引数/リクエスト**: `self` のみ
* 根拠: (行番号: 84 / 抜粋: "def _get_uptime(self) -> str:")
...
* 根拠: `def check_system_resources(self):` (行番号: 98〜138 / 抜粋: "def check_system_resources(self):")


* **引数/リクエスト**: `self` のみ
* 根拠: (行番号: 98 / 抜粋: "def check_system_resources(self):")
...
* 根拠: `def check_network_and_apis(self):` (行番号: 140〜170 / 抜粋: "def check_network_and_apis(self):")、NatureRemoのスキップ判定 (行番号: 153〜158 / 抜粋: "if config.NATURE_REMO_ACCESS_TOKEN:")


* **引数/リクエスト**: `self` のみ
* 根拠: (行番号: 140 / 抜粋: "def check_network_and_apis(self):")
...
* 根拠: `def check_database(self):` (行番号: 173〜201 / 抜粋: "def check_database(self):")
...
* **引数/リクエスト**: `self` のみ
* 根拠: (行番号: 173 / 抜粋: "def check_database(self):")
...
* 根拠: `def check_services(self):` (行番号: 204〜221 / 抜粋: "def check_services(self):"), `with ThreadPoolExecutor(max_workers=len(targets)) as executor:\n            self.results.extend(executor.map(self._wait_for_service, targets))` (行番号: 200〜201 / 抜粋: "with ThreadPoolExecutor(max_workers=len(targets)) as executor:")


* **引数/リクエスト**: `self` のみ
* 根拠: (行番号: 204 / 抜粋: "def check_services(self):")
...
* 根拠: (行番号: 204〜221 / 抜粋: "def check_services(self):")
...
* 根拠: `def _wait_for_service(self, target: dict) -> CheckResult:` (行番号: 223〜246 / 抜粋: "def _wait_for_service(self, target: dict) -> CheckResult:")
...
* 根拠: `def check_peripherals(self) -> None:` (行番号: 249〜333 / 抜粋: "def check_peripherals(self) -> None:")


* **引数/リクエスト**: `self` のみ
* 根拠: (行番号: 249 / 抜粋: "def check_peripherals(self) -> None:")
...
* 根拠: `def check_recent_logs(self):` (行番号: 336〜378 / 抜粋: "def check_recent_logs(self):")


* **引数/リクエスト**: `self` のみ
* 根拠: (行番号: 336 / 抜粋: "def check_recent_logs(self):")
