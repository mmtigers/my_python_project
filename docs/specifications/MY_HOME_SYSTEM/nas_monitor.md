...
* 根拠: `class NasMonitor:` (行番号: 23〜469 / 抜粋: "class NasMonitor:")
...
* 根拠: `def __init__(self) -> None:` (行番号: 26〜46 / 抜粋: "def __init__(self) -> None:")


* **引数/リクエスト**: なし
* 根拠: `def __init__(self) -> None:` (行番号: 26 / 抜粋: "def __init__(self) -> None:")
...
* **エラーハンドリング**: なし
* 根拠: 関数内の処理全体 (行番号: 26〜46 / 抜粋: "def __init__(self) -> None:")
...
* 根拠: `def _load_state(self) -> Dict[str, bool]:` (行番号: 48〜66 / 抜粋: "def _load_state(self) -> Di...")


* **引数/リクエスト**: なし
* 根拠: `def _load_state(self) -> Dict[str, bool]:` (行番号: 48 / 抜粋: "def _load_state(self) -> Di...")
...
* 根拠: `def _save_state(self, state: Dict[str, bool]) -> None:` (行番号: 68〜77 / 抜粋: "def _save_state(self, state...")
...
* 根拠: `def check_ping(self) -> bool:` (行番号: 79〜91 / 抜粋: "def check_ping(self) -> boo...")


* **引数/リクエスト**: なし
* 根拠: `def check_ping(self) -> bool:` (行番号: 79 / 抜粋: "def check_ping(self) -> boo...")
...
* 根拠: `def check_mount(self) -> bool:` (行番号: 93〜97 / 抜粋: "def check_mount(self) -> bo...")


* **引数/リクエスト**: なし
* 根拠: `def check_mount(self) -> bool:` (行番号: 93 / 抜粋: "def check_mount(self) -> bo...")
...
* **副作用**: なし
* 根拠: 関数内の処理全体 (行番号: 93〜97 / 抜粋: "def check_mount(self) -> bo...")
...
* 根拠: `def check_write_permission(self) -> bool:` (行番号: 108〜178 / 抜粋: "def check_write_permission(self) -> bool:")、`retry_with_backoff(...)`呼び出し (行番号: 142〜148 / 抜粋: "retry_with_backoff(\n                _attempt,\n                max_retries=self.write_check_retries - 1,\n                retryable_exceptions=(subprocess.TimeoutExpired,),")


* **引数/リクエスト**: なし
* 根拠: `def check_write_permission(self) -> bool:` (行番号: 108 / 抜粋: "def check_write_permission(self) -> bool:")
...
* 根拠: `def sync_fallback_data(self) -> None:` (行番号: 180〜221 / 抜粋: "def sync_fallback_data(self...")、`fallback_assets_dir = os.path.join(self.fallback_dir, "assets")` (行番号: 165)、`nas_assets_dir = os.path.join(self.nas_project_root, "assets")` (行番号: 170)


* **引数/リクエスト**: なし
* 根拠: `def sync_fallback_data(self) -> None:` (行番号: 180 / 抜粋: "def sync_fallback_data(self...")
...
* 根拠: `def _cleanup_empty_dirs(self, path: str) -> None:` (行番号: 223〜235 / 抜粋: "def _cleanup_empty_dirs(sel...")
...
* 根拠: `def get_disk_usage(self) -> Optional[Dict[str, float]]:` (行番号: 237〜249 / 抜粋: "def get_disk_usage(self) ->...")


* **引数/リクエスト**: なし
* 根拠: `def get_disk_usage(self) -> Optional[Dict[str, float]]:` (行番号: 237 / 抜粋: "def get_disk_usage(self) ->...")
...
* **副作用**: なし
* 根拠: 関数内の処理全体 (行番号: 237〜249 / 抜粋: "def get_disk_usage(self) ->...")
...
* 根拠: 定義部 (行番号: 251〜283 / 抜粋: "def cleanup_old_files(")
...
* 根拠: `def run_retention_cleanup(self) -> None:` (行番号: 285〜343 / 抜粋: "def run_retention_cleanup(sel...")
...
* **引数/リクエスト**: なし
* 根拠: `def run_retention_cleanup(self) -> None:` (行番号: 285 / 抜粋: "def run_retention_cleanup(sel...")
...
* 根拠: `def save_to_db(self, ping_ok: bool, mount_ok: bool, usage: Optional[Dict[str, float]]) -> None:` (行番号: 345〜382 / 抜粋: "def save_to_db(self, ping_...")
...
* 根拠: 定義部 (行番号: 345 / 抜粋: "def save_to_db(self, ping_...")
...
* **エラーハンドリング**: なし
* 根拠: 関数内の処理全体 (行番号: 345〜382 / 抜粋: "def save_to_db(self, ping_...")
...
* 根拠: `def run(self) -> None:` (行番号: 384〜469 / 抜粋: "def run(self) -> None:")
...
* **引数/リクエスト**: なし
* 根拠: `def run(self) -> None:` (行番号: 384 / 抜粋: "def run(self) -> None:")
