...
* 根拠: `def check_mount(self) -> bool:` (行番号: 92〜96 / 抜粋: "def check_mount(self) -> bo...")


* **引数/リクエスト**: なし
* 根拠: `def check_mount(self) -> bool:` (行番号: 92 / 抜粋: "def check_mount(self) -> bo...")
...
* **副作用**: なし
* 根拠: 関数内の処理全体 (行番号: 92〜96 / 抜粋: "def check_mount(self) -> bo...")
...
* 根拠: `def check_write_permission(self) -> bool:` (行番号: 107〜177 / 抜粋: "def check_write_permission(self) -> bool:")、`retry_with_backoff(...)`呼び出し (行番号: 142〜148 / 抜粋: "retry_with_backoff(\n                _attempt,\n                max_retries=self.write_check_retries - 1,\n                retryable_exceptions=(subprocess.TimeoutExpired,),")


* **引数/リクエスト**: なし
* 根拠: `def check_write_permission(self) -> bool:` (行番号: 107 / 抜粋: "def check_write_permission(self) -> bool:")
...
* 根拠: `def sync_fallback_data(self) -> None:` (行番号: 179〜220 / 抜粋: "def sync_fallback_data(self...")、`fallback_assets_dir = os.path.join(self.fallback_dir, "assets")` (行番号: 165)、`nas_assets_dir = os.path.join(self.nas_project_root, "assets")` (行番号: 170)


* **引数/リクエスト**: なし
* 根拠: `def sync_fallback_data(self) -> None:` (行番号: 179 / 抜粋: "def sync_fallback_data(self...")
...
* 根拠: `def _cleanup_empty_dirs(self, path: str) -> None:` (行番号: 222〜234 / 抜粋: "def _cleanup_empty_dirs(sel...")
...
* 根拠: `def get_disk_usage(self) -> Optional[Dict[str, float]]:` (行番号: 236〜248 / 抜粋: "def get_disk_usage(self) ->...")


* **引数/リクエスト**: なし
* 根拠: `def get_disk_usage(self) -> Optional[Dict[str, float]]:` (行番号: 236 / 抜粋: "def get_disk_usage(self) ->...")
...
* **副作用**: なし
* 根拠: 関数内の処理全体 (行番号: 236〜248 / 抜粋: "def get_disk_usage(self) ->...")
...
* 根拠: 定義部 (行番号: 250〜282 / 抜粋: "def cleanup_old_files(")
...
* 根拠: `def run_retention_cleanup(self) -> None:` (行番号: 284〜342 / 抜粋: "def run_retention_cleanup(sel...")
...
* **引数/リクエスト**: なし
* 根拠: `def run_retention_cleanup(self) -> None:` (行番号: 284 / 抜粋: "def run_retention_cleanup(sel...")
...
* 根拠: `def save_to_db(self, ping_ok: bool, mount_ok: bool, usage: Optional[Dict[str, float]]) -> None:` (行番号: 344〜381 / 抜粋: "def save_to_db(self, ping_...")
...
* 根拠: 定義部 (行番号: 344 / 抜粋: "def save_to_db(self, ping_...")
...
* **エラーハンドリング**: なし
* 根拠: 関数内の処理全体 (行番号: 344〜381 / 抜粋: "def save_to_db(self, ping_...")
...
* 根拠: `def run(self) -> None:` (行番号: 383〜468 / 抜粋: "def run(self) -> None:")
...
* **引数/リクエスト**: なし
* 根拠: `def run(self) -> None:` (行番号: 383 / 抜粋: "def run(self) -> None:")
