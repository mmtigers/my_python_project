...
* 根拠: `{'id': 1023, 'title': '土日の宿題', ... 'days': '4,5,6', 'reset_period': 'weekly', ...}` (行番号: 141 / 抜粋: "'days': '4,5,6', 'reset_period': 'weekly'"), 直前のコメント (行番号: 124〜125 / 抜粋: "金・土・日のいずれかで完了報告すればよく、reset_period='weekly'により\n    # その週(月曜起点)の残りの表示対象日でも既に達成済みとして扱われ、カードは再度表示されない。")
