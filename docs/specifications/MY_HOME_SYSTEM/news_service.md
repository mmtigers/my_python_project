...
* [common.md](./common.md) - `get_retry_session`を再エクスポートするFacade
* [network.md](./network.md) - `get_retry_session`の実体
...
* 根拠: `if __name__ == "__main__":` 以下のブロック (行番号: 60〜73 / 抜粋: "if __name__ == "__main__":")


* **引数/リクエスト**: 該当なし
* 根拠: 引数受け取り処理なし (行番号: 60〜73 / 抜粋: "if __name__ == "__main__":")


* **戻り値/レスポンス**: 該当なし
* 根拠: 戻り値定義なし (行番号: 60〜73 / 抜粋: "if __name__ == "__main__":")
...
* **エラーハンドリング**: なし
* 根拠: 例外処理なし (行番号: 60〜73 / 抜粋: "if __name__ == "__main__":")
