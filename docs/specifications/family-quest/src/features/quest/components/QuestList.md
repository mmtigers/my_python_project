...
* 根拠: (行番号: 82 / 抜粋: "const questId = quest.quest_id;") と (行番号: 399〜400 / 抜粋: "const idA = Number(a.quest_id ?? 0);\n            const idB = Number(b.quest_id ?? 0);")
