...
QUESTS = [
    ...
    # 変更: 「子供の寝かしつけ」を「昨夜の〜」に変更し、翌朝に押せるようにする
    {'id': 500, 'title': '昨夜の寝かしつけ', 'type': 'daily', 'target': 'mom', 'days': '0,1,2,3,4,5,6', 'exp': 300, 'gold': 200, 'icon': '💤', 'desc': '子供を寝かしつけた（翌朝申請用）'},
    {'id': 501, 'title': '昨夜の寝かしつけ', 'type': 'daily', 'target': 'dad', 'days': '0,1,2,3,4,5,6', 'exp': 300, 'gold': 200, 'icon': '💤', 'desc': '子供を寝かしつけた（翌朝申請用）'},

    # 追加: 寝室の布団上げと掃除 (土日) - パパ・ママ両方
    {'id': 502, 'title': '寝室の布団上げ＆掃除', 'type': 'daily', 'target': 'dad', 'days': '5,6', 'exp': 40, 'gold': 100, 'icon': '🛏️', 'desc': '布団をあげて掃除機をかける'},
    {'id': 503, 'title': '寝室の布団上げ＆掃除', 'type': 'daily', 'target': 'mom', 'days': '5,6', 'exp': 40, 'gold': 100, 'icon': '🛏️', 'desc': '布団をあげて掃除機をかける'},

    # 追加: アクセサリーの装着と片付け (土日) - ママ
    {'id': 504, 'title': 'アクセ装着と片付け', 'type': 'daily', 'target': 'mom', 'days': '5,6', 'exp': 15, 'gold': 20, 'icon': '💍', 'desc': '週末のおしゃれを楽しみ、定位置に戻す'},

    # 追加: お菓子を我慢する (毎日) - ママ
    {'id': 505, 'title': 'お菓子を我慢する', 'type': 'daily', 'target': 'mom', 'days': '0,1,2,3,4,5,6', 'exp': 20, 'gold': 30, 'icon': '🙅‍♀️', 'desc': '間食を控えて健康に'},
    ...
    #     "icon": "👟",
    #     "days": "0,1,2,3,4,5,6",
    #     # 親なので pre_requisite_quest_id は指定しない (または None)
    # },

    # # 2. 子クエスト (ID: 102) - ID:101をクリアすると開放
    # {
    #     "id": 102,
    #     "title": "【テスト】玄関掃除",
    #     "desc": "ほうきで砂を掃き出そう",
    ...
    #     "icon": "🧹",
    #     "days": "0,1,2,3,4,5,6",
    #     "pre_requisite_quest_id": 101  # ★ここで親を指定
    # },
