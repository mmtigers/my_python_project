...
REWARDS = [
    ...
    {'id': 30, 'title': 'ローラースケート場チケット', 'category': 'special', 'cost_gold': 1000, 'icon_key': '🛼', 'desc': '伊丹スカイパーク等で風になろう'},
    {'id': 31, 'title': 'キッズランドチケット', 'category': 'special', 'cost_gold': 1500, 'icon_key': '🏰', 'desc': '室内遊園地で遊び放題'},
