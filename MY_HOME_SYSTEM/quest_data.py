...
REWARDS = [
    ...
    # --- Premium (夢の報酬) ---
    {'id': 99, 'title': 'ユニバのチケット (ペア)', 'category': 'special', 'cost_gold': 30000, 'icon_key': '🎢', 'desc': '夢の国で最高の一日を', 'target': 'mom'},
    ...
    # 追加: Switchゲーム (350G)
    {'id': 121, 'title': 'Switchのゲーム(45分)', 'category': 'small', 'cost_gold': 350, 'icon_key': '🎮', 'desc': '45分間ゲームで遊べる券。宿題が終わってから!', 'target': 'children'},
]
